...
const StasticsByDay = ref()

StasticsByDay.value = await $api('/api/dashboard/vendeur/stasticsByDay').then(response => response.data)
  ...
  return [
    {
      ...
      chartOptions: {
        ...
        xaxis: {
          categories: StasticsByDay.value.colis.days,
          axisBorder: {
            show: true,
            color: borderColor,
          },
      ...
      series: [{
        data: StasticsByDay.value.colis.values,
      }],
    },
