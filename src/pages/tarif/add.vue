...
import QrcodeVue, { RenderAs } from 'qrcode.vue'
 ...
 const invoiceData = ref({
    invoice: {
        ...
        total: 3171,
        avatar: "/vuexy-vuejs-admin-template/demo-1/assets/avatar-3-BxDW4ia1.png",
        invoiceStatus: "Paid",
        balance: -205,
        dueDate: "2025-02-25"
    },
 ...
 <template>
         <qrcode-vue value="badredlsdsd"     :render-as="renderAs"
         width="500px" size="200" />
